...
function findExpensiveMonth (monthsOftheYear) {
  var expensiveMonth = 0;
  var highestOverMonth =  monthsOftheYear[0].over;
  for (var i = 1; i < monthsOftheYear.length; i++) {
      if (monthsOftheYear[i].over > highestOverMonth) {
          expensiveMonth = i;
          highestOverMonth = monthsOftheYear[i].over;
      }
  }
    return expensiveMonth;
};

findExpensiveMonth(monthsOftheYear);
